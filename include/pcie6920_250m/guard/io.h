...
public:
	...
	{
		switch (info.parse_rule)
		{
		case enums::parse_rule::raw_data:
			return self_type::_read_partial<enums::parse_rule::raw_data>(info.channel_quantity, NGS_PP_PERFECT_FORWARD(result));
		case enums::parse_rule::iq:
			return self_type::_read_partial<enums::parse_rule::iq>(info.channel_quantity, NGS_PP_PERFECT_FORWARD(result));
		case enums::parse_rule::amplitude_phase:
			return self_type::_read_partial<enums::parse_rule::amplitude_phase>(info.channel_quantity, NGS_PP_PERFECT_FORWARD(result));
		}
		return 0;
	}
};
